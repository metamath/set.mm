...
$)
  ...
  ${
    $d A x y z w $.
    $( The Kuratowski converse of a set is a set. 
       (Contributed by SF, 13-Jan-2015.) $)
  ...
  $( The Kuratowski cross product of two sets is a set. 
     (Contributed by SF, 13-Jan-2015.) $)
  ...
  ${
    $d A x y z w $.
    $( The P6 operator applied to a set yields a set. 
       (Contributed by SF, 13-Jan-2015.) $)
  ...
  ${
    $d x y z w $.
    $( The Kuratowski subset relationship is a set. 
       (Contributed by SF, 13-Jan-2015.) $)
  ...
  ${
    $d A x y z w $.
    $( The Kuratowski singleton image of a set is a set. 
       (Contributed by SF, 14-Jan-2015.) $)
  ...
  ${
    $d A x y z w $.
    $( Alternate expression for unit power classes. 
  ...
  $( The unit power class preserves sethood. 
     (Contributed by SF, 14-Jan-2015.) $)
  ...
  $( The Kuratowski composition of two sets is a set. 
     (Contributed by SF, 14-Jan-2015.) $)
  ...
  $( The Kuratowski image functor preserves sethood. 
     (Contributed by SF, 14-Jan-2015.) $)
  ...
  ${
    $d x y $.
    $( Definition of ` _I_k ` in terms of ` SSet_k ` . 
       (Contributed by SF, 14-Jan-2015.) $)
  ...
  $( The Kuratowski identity relationship is a set. 
     (Contributed by SF, 14-Jan-2015.) $)
  idkex $p |- _I_k e. _V $=
  ...
  ${
    ...
    setswith $p |- { x | A e. x } =
      ...
      ( vy cvv wcel cv cab cssetk csn cimak c0 cif wceq copk wrex wa wex eqtr4d
      vex wn df-rex elsn anbi1i exbii snex opkeq1 eleq1d ceqsexv elssetkg mpan2
      3bitri wb syl5rbb abbidv df-imak syl6eqr iftrue elex con3i alrimiv sylibr
      wal ab0 iffalse pm2.61i ) BDEZBAFZEZAGZVFHBIZIZJZKLZMVFVIVLVMVFVICFZVGNZH
      EZCVKOZAGVLVFVHVQAVQVJVGNZHEZVFVHVQVNVKEZVPPZCQVNVJMZVPPZCQVSVPCVKUAWAWCC
      VTWBVPVNVJCSUBUCUDVPVSCVJBUEWBVOVRHVNVJVGUFUGUHUKVFVGDEVSVHULASBVGDDUIUJU
      MUNACHVKUOUPVFVLKUQRVFTZVIKVMWDVHTZAVBVIKMWDWEAVHVFBVGURUSUTVHAVCVAVFVLKV
      DRVE $.
      $( [14-Jan-2015] $)

    $( The class of all sets that contain ` A ` exist. 
       (Contributed by SF, 14-Jan-2015.) $)
  ...
  ${
    $d A x y z $.
    $( The union of a unit power class is the original set. 
  ...
  $( Biconditional existence for unit power class. 
     (Contributed by SF, 20-Jan-2015.) $)
  ...
  ${
    $d A x y t $.
    $( Definition of power set for existence proof. 
  ...
  ${
    ...
    eqpw1uni $p |- ( A C_ 1c -> A = ~P1 U. A ) $=
      ( vx vy vz c1c wss cuni cv wcel wi csn wceq wb el1c wa eleq2 eleq1 syl6bb
      wex syl5bi cpw1 ssel pw1ss1c sseli a1i wel snid snex anbi12d spcev eluni
      vex mpan sylibr wrex eluni2 weq sneq eleq1d biimprcd elsn imbi12d exlimiv
      imbi1d mpbiri sylbi rexlimdv impbid2 snelpw1 bibi12d syl5ibrcom pm5.21ndd
      syli exlimdv eqrdv ) AEFZBAAGZUAZVPBHZEIZVSAIZVSVRIZAEVSUBZWBVTJVPVREVSVQ
      
      VKVNTVLVO $.
      $( [26-Jan-2015] $)
  $}
  ...
  ${
    ...
    pw1equn.1 $e |- A e. _V $.
    pw1equn.2 $e |- B e. _V $.
    $( A condition for a unit power class to equal a union. 
       (Contributed by SF, 26-Jan-2015.) $)
  ...
  ${
    $d x y $.  $d y ph $.
    $( Alternate definition of existential uniqueness in terms of
       abstraction. 
  ...
  ${
    ...
    $( If there is a unique object satisfying a property ` ph ` , then the set
       of all elements that satisfy ` ph ` exists. 
...
$)
  ...
  ${
    ...
    $( Bound-variable hypothesis builder for the ` iota ` class. 
       (Contributed by ?who?, 23-Aug-2011.) $)
  ...
  ${
    ...
    $( Variable substitution in description binder.  Compare ~ sb8eu . 
       (Contributed by ?who?, 18-Mar-2013.) $)
    sb8iota $p |- ( iota x ph ) = ( iota y [ y / x ] ph ) $=
      ( vz vw cv wceq wb wal cab cuni wsbc cio ax-17 sb8 equsb3 hbxfrbi dfiota2
      sbbi hbsb hbbi sbequ cbval bibi2i bitri albii 3bitri abbii unieqi 3eqtr4i
      ) ABGEGZHZIZBJZEKZLABCGZMZUQULHZIZCJZEKZLABNURCNUPVBUOVAEUOUNBFGZMZFJUNBU
      QMZCJVAUNBFUNFOPVDVEFCVDABVCMZUMBVCMZICAUMBFTVFVGCABFCDUAVGVCULHZCFBEQVHC
      ORUBRVEFOUNFCBUCUDVEUTCVEURUMBUQMZIUTAUMBCTVIUSURCBEQUEUFUGUHUIUJABESURCE
      SUK $.
      $( [18-Mar-2013] $)
  $}
  ...
  ${
    ...
    $( Formula-building deduction rule for iota. 
       (Contributed by ?who?, 20-Aug-2011.) $)
  ...
  iota1 $p |- ( E! x ph -> ( ph <-> ( iota x ph ) = x ) ) $=
    ( vz weu weq wb wal wex cio cv wceq df-eu ax-4 iotaval eqeq2d bitr4d syl6bb
    eqcom exlimiv sylbi ) ABDABCEZFZBGZCHAABIZBJZKZFZABCLUCUGCUCAUEUDKZUFUCAUAU
    HUBBMUCUDCJUEABCNOPUEUDRQST $.
    $( [23-Aug-2011] $)
  $}
  ...
  ${
    ...
    $( Deduction version of ~ reiota2f . 
       (Contributed by ?who?, 17-Feb-2013.) $)
  ...
  ${
    ...
    $( A condition that allows us to represent "the unique element in ` A `
       such that ` ph ` " with a class expression ` B ` . 
       (Contributed by ?who?, 23-Aug-2011.) $)
  ...
  ${
    ...
    reiotass2 $p |- ( ( ( A C_ B /\ A. x e. A ( ph -> ps ) ) /\ ( E. x e. A ph
      ...
      reiotasbc reiotacl rspsbc sbcimg sylibd mpid sylc wb ssel ad2antrr simprr
  ...
  ${
    $( Alternate definition of iota in terms of the ` if ` operator. 
       (Contributed by ?who?, 29-Jan-2015.) $)
