...
$)
  ...
  $( A probability is an element of [ 0 , 1 ].  First axiom of Kolmogorov.
     (Contributed by Thierry Arnoux, 25-Dec-2016.) $)
  prob01 $p |- ( ( P e. Prob /\ A e. dom P ) -> ( P ` A ) e. ( 0 [,] 1 ) ) $=
    ( cprb wcel cdm wa cfv cxr cc0 cle wbr c1 cicc co cpnf cmeas cuni adantr wb
    w3a domprobmeas measvxrge0 sylan elxrge0 sylib simpr crn measbase unielsiga
    csiga 3syl wss elssuni adantl measssd probtot breq2d mpbid sylanbrc 0xr 1xr
    df-3an elicc1 mp2an sylibr ) BCDZABEZDZFZABGZHDZIVJJKZVJLJKZTZVJILMNDZVIVKV
    LFZVMVNVIVJIOMNDZVPVFBVGPGDZVHVQBUAZAVGBUBUCVJUDUEVIVJVGQZBGZJKZVMVIAVTVGBV
    FVRVHVSRZVFVHUFVIVRVGUJUGQDVTVGDWCVGBUHVGUIUKVHAVTULVFAVGUMUNUOVFWBVMSVHVFW
    ALVJJBUPUQRURVKVLVMVBUSIHDLHDVOVNSUTVAILVJVCVDVE $.
  ...
  $( The universe is an element of the domain of the probability, the universe
     (entire probability space) being ` U. dom P ` in our construction.
  ...
  nuleldmp $p |- ( P e. Prob -> (/) e. dom P ) $=
    ( cprb wcel cdm csiga crn cuni c0 domprobsiga 0elsiga syl ) ABCADZEFGCHLCAI
    LJK $.
  ...
  ${
    ...
    $( The probability of the union of a countable disjoint set of events is
       ...
       (Contributed by Thierry Arnoux, 25-Dec-2016.) $)
    probcun $p |- ( ( P e. Prob /\ A e. ~P dom P /\ ( A ~<_ _om
  ...
  ${
    ...
    probun $p |- ( ( P e. Prob /\ A e. dom P /\ B e. dom P ) ->
      ( ( A i^i B ) = (/) ->
                          ( P ` ( A u. B ) ) = ( ( P ` A ) + ( P ` B ) ) ) ) $=
      ( vx wcel c0 wceq cfv caddc co wa eqtrdi sylan9eqr fveq2d 3ad2ant2 adantr
      cc0 syl2anc sselid cr cprb cdm w3a cin wi simpll1 simplr simpr cdif disj3
  ...
  probdif $p |- ( ( P e. Prob /\ A e. dom P /\ B e. dom P ) ->
    ( P ` ( A \ B ) ) = ( ( P ` A ) - ( P ` ( A i^i B ) ) ) ) $=
    ( cprb wcel cdm w3a cfv cin cmin co cdif caddc wceq syl3an1 unitsscn prob01
    cc syl2anc sselid cun inundif fveq2i simp1 csiga cuni domprobsiga difelsiga
    crn inelsiga c0 inindif probun mpi syl3anc eqtr3id oveq1d c1 pncan2d eqtr2d
    cc0 cicc ) CDEZACFZEZBVDEZGZACHZABIZCHZJKVJABLZCHZMKZVJJKVLVGVHVMVJJVGVHVIV
    KUAZCHZVMVNACABUBUCVGVCVIVDEZVKVDEZVOVMNZVCVEVFUDZVCVDUEUIUFEZVEVFVPCUGZABV
  ...
  probdsb $p |- ( ( P e. Prob /\ A e. dom P ) ->
    ...
    cin c1 syl3anc probtot wss elssuni sseqin2 sylib fveq2d oveqan12d eqtrd ) B
    CDZABEZDZFZUIGZAHBIZULBIZULAQZBIZJKZRABIZJKUKUHULUIDUJUMUQLUHUJMZUKBUSNUHUJ
    OULABPSUHUJUNRUPURJBTUJUOABUJAULUAUOALAUIUBAULUCUDUEUFUG $.
  ...
  ${
    ...
    ${
      ...
      probvalrnd $p |- ( ph -> ( P ` A ) e. RR ) $=
        ( cc0 c1 cicc co cr cfv unitssre cprb wcel cdm prob01 syl2anc sselid )
  ...
  ${
    ...
    totprobd $p |- ( ph -> ( P ` A ) = sum* b e. B ( P ` ( b i^i A ) ) ) $=
      ( vc cuni cin cfv wceq wcel syl syl2anc adantr cesum wss elssuni sseqtrrd
      cv cdm sseqin2 sylib fveq2d cmpt cmeas cpw com cdom wbr wdisj domprobmeas
      cprb measinb measvun syl112anc cc0 c1 cicc co eqidd wa simpr ineq1d csiga
      crn domprobsiga sigaclcu syl3anc inelsiga prob01 fvmptd elelpwi esumeq2dv
      3eqtr3d eqtr3d ) ACMZBNZDOZBDOCEUEZBNZDOZEUAZAWCBDABWBUBWCBPABDUFZMZWBABW
      
      TWEBWIVOVNWFDVPSVQVSVTWA $.
  $}
  ...
  ${
    ...
    totprob $p |- ( ( P e. Prob /\ A e. dom P /\
      ( U. B = U. dom P /\ B e. ~P dom P /\ ( B ~<_ _om /\ Disj_ b e. B b ) ) )
      ...
      simp33r id cbvesumv eqtr4di ) CFGZACHZGZBIUQIJZBUQKGZBLMNZDBDOZPZUAZQZQZA
  ...
  probfinmeasb $p |- ( ( M e. ( measures ` S ) /\ ( M ` U. S ) e. RR+ ) ->
    ...
    ( cmeas cfv wcel cuni crp wa cxdiv cofc co crn cdm c1 wceq measdivcst csiga
    cprb adantr fveq2d wfn measfn measbase simpr ofcfn fndmd measbasedom sylibr
    eleqtrrd unieqd unielsiga syl eqidd ofcval mpdan cc0 wne rpre rpne0 syl2anc
    cr xdivid adantl 3eqtrd elprob sylanbrc ) BACDZEZAFZBDZGEZHZBVJIJKZCLFEZVMM
    ZFZVMDZNOVMREVLVMVOCDZEVNVLVMVGVRVJABPVLVOACVLAVMVLAVJIBQLFZGVHBAUAVKABUBSZ
    VHAVSEZVKABUCSZVHVKUDZUEUFZTUIVMUGUHVLVQVIVMDZVJVJIKZNVLVPVIVMVLVOAWDUJTVLV
    IAEZWEWFOVLWAWGWBAUKULVLAVJVJIBVSGVIVTWBWCVLWGHVJUMUNUOVKWFNOZVHVKVJVAEVJUP
    UQWHVJURVJUSVJVBUTVCVDVMVEVF $.

  ${
    $d x M $.  $d x y S $.
    $( Alternate version of ~ probfinmeasb .  (Contributed by Thierry Arnoux,
       17-Dec-2016.)  (New usage is discouraged.) $)
    probfinmeasbALTV $p |- ( ( M e. ( measures ` S ) /\ ( M ` U. S ) e. RR+ )
                   -> ( x e. S |-> ( ( M ` x ) /e ( M ` U. S ) ) ) e. Prob ) $=
      ( vy cmeas cfv wcel cuni crp wa cv cxdiv co crn wceq cvv wral fveq2i cpw
      c1 cmpt cprb measdivcstALTV ovex rgenw dmmptg ax-mp eleqtrrdi measbasedom
      cdm sylibr unieqi csiga measbase cdif com wbr wi wss w3a isrnsigau simprd
      cdom simp1d syl id rpxdivcld anim12i fveq2 oveq1d eqid fvmptg cr cc0 rpre
      wne rpne0 xdivid syl2anc adantl eqtrd eqtrid elprob sylanbrc ) CBEFZGZBHZ
      CFZIGZJZABAKZCFZWHLMZUAZENHGZWNUJZHZWNFZTOWNUBGWJWNWPEFZGWOWJWNWEWSAWHBCU
      CWPBEWMPGZABQWPBOWTABWLWHLUDUEABWMPUFUGZRUHWNUIUKWJWRWGWNFZTWQWGWNWPBXAUL
  ...
  ${
    ...
    probmeasb $p |- ( ( M e. ( measures ` S ) /\ A e. S /\ ( M ` A ) e. RR+ )
      ...
      ( vy cmeas cfv wcel cin co cmpt cuni wceq cc0 cpnf fveq2d adantr syl cxr
      cr crp w3a cv cdiv crn cdm c1 cprb cxdiv measinb measdivcstALTV stoic3 wa
      eqidd simpr ineq1d simp1 csiga measbase simp2 inelsiga syl3anc measvxrge0
      cicc syl2anc fvmptd oveq1d wne cle wbr iccssxr sselid simp3 rpred iccgelb
      0xr pnfxr mp3an12 wss inss2 a1i measssd xrrege0 syl22anc rpne0d mpteq2dva
      rexdiv wral rerpdivcld ralrimiva dmmptg eqcomd 3eltr3d measbasedom sylibr
      eqtrd unieqd rpcnd incom elssuni dfss2 sylib diveq1bd sgon baselsiga 4syl
      eqtrid 1red elprob sylanbrc ) DCFGZHZBCHZBDGZUAHZUBZACAUCZBIZDGZXNUDJZKZF
      UELHZYAUFZLZYAGZUGMYAUHHXPYAYCFGZHYBXPACXQECEUCZBIZDGZKZGZXNUIJZKZXKYAYFX
      LXMYJXKHXOYMXKHEBCDUJAXNCYJUKULXPACYLXTXPXQCHZUMZYLXSXNUIJZXTYOYKXSXNUIYO
      ...
      
      HUVACHUUCUUFCXDUVACXEXFXPXHVFWPYAXIXJ $.
  $}
...
$)
  ...
  ${
    ...
    ( ( cprob ` P ) ` <. A , B >. ) = ( ( P ` ( A i^i B ) ) / ( P ` B ) ) ) $=
      ( va vb vp cprb wcel cdm ccprob cfv co cin cdiv cv cvv cmpo fveq1 oveq12d
      wceq w3a cop df-ov df-cndprob mpoeq123dv id dmexg mpoexga syl2anc fvmptd3
      3ad2ant1 wa simprl simprr ineq12d fveq2d simp2 simp3 ovexd ovmpod eqtr3id
      dmeq ) CGHZACIZHZBVDHZUAZABUBCJKZKABVHLABMZCKZBCKZNLZABVHUCVGDEABVDVDDOZE
      ...
      PHCGUGZWHDEVDVDVRPPUHUIUJUKVGVMATZVNBTZULULZVPVJVQVKNWKVOVICWKVMAVNBVGWIW
      JUMVGWIWJUNZUOUPWKVNBCWLUPSVCVEVFUQVCVEVFURVGVJVKNUSUTVA $.
  $}
  ...
  cndprobin $p |- ( ( ( P e. Prob /\ A e. dom P /\ B e. dom P ) /\
    ...
    cop sselid cin cdiv wceq cndprobval oveq1d cicc simp1 csiga crn domprobsiga
  ...
  cndprobtot $p |- ( ( P e. Prob /\ A e. dom P /\ ( P ` A ) =/= 0 ) ->
    ...
    wa simpl unveldomd simpr cndprobval syl3anc elssuni 3ad2ant2 sseqin2 fveq2d
    wss sylib oveq1d cicc cc prob01 elunitcn syl simp3 dividd 3eqtrd ) BCDZABEZ
    DZABFZGHZIZVAJZAKBLFFZVFAMZBFZVCNOZVCVCNOPUTVBVGVJQZVDUTVBSZUTVFVADVBVKUTVB
    TZVLBVMUAUTVBUBVFABUCUDRVEVIVCVCNVEVHABVEAVFUIZVHAQVBUTVNVDAVAUEUFAVFUGUJUH
    UKVEVCVEVCGPULODZVCUMDUTVBVOVDABUNRVCUOUPUTVBVDUQURUS $.
  ...
  cndprobnul $p |- ( ( P e. Prob /\ A e. dom P /\ ( P ` A ) =/= 0 ) ->
    ...
    simp1 simp2 cndprobval syl3anc 0in fveq2i oveq1i a1i probnul oveq1d c1 cicc
    cc prob01 3adant3 elunitcn simp3 div0d 3eqtrd eqtrd ) BCDZABEZDZABFZGHZIZJA
    KBLFFZJAMZBFZVBNOZGVDUSJUTDZVAVEVHPUSVAVCSZVDUSVIVJBQRUSVAVCTJABUAUBVDVHJBF
    ZVBNOZGVBNOGVHVLPVDVGVKVBNVFJBAUCUDUEUFVDVKGVBNVDUSVKGPVJBUGRUHVDVBVDVBGUIU
    JODZVBUKDUSVAVMVCABULUMVBUNRUSVAVCUOUPUQUR $.
  ...
  bayesth $p |- ( ( ( P e. Prob /\ A e. dom P /\ B e. dom P ) /\
    ...
    ( cprb wcel w3a cfv cc0 wne cop cmul co cdiv cc unitsscn 3adant2 sselid cin
...
$)
  ...
  ${
    ...
    isrrvv $p |- ( ph -> ( X e. ( rRndVar ` P ) <-> ( X : U. dom P --> RR /\
      ...
      ( crrv cfv wcel cdm cbrsiga cmbfm co cuni cmap ccnv cv wa cr csiga cvv wf
      cima wral rrvmbfm cprb crn domprobsiga brsigarn elrnsiga ismbfm unibrsiga
      syl mp1i oveq1i eleq2i wb reex uniexd elmapg sylancr bitrid anbi1d 3bitrd
      ) ADCFGHDCIZJKLHDJMZVDMZNLZHZDOBPUBVDHBJUCZQVFRDUAZVIQACDEUDABVDJDACUEHVD
      SUFMZHECUGULZJRSGHJVKHAUHJRUIUMUJAVHVJVIVHDRVFNLZHZAVJVGVMDVERVFNUKUNUOAR
      THVFTHVNVJUPUQAVDVKVLURRVFDTTUSUTVAVBVC $.
  ...
  ${
    ...
    0rrv $p |- ( ph -> ( x e. U. dom P |-> 0 ) e. ( rRndVar ` P ) ) $=
      ...
      xpeq2i xp0 eqtrdi dmeqd adantl cprb csiga domprobsiga 0elsiga 3syl adantr
      dm0 eqeltrd eqeltrid dmxp unveldomd pm2.61dane ralrimivw isrrvv mpbir2and
  ...
  ${
    ...
    rrvadd $p |- ( ph -> ( X oF + Y ) e. ( rRndVar ` P ) ) $=
      ...
      cdm cmpo cuni cmpt ccom nfmpt1 rrvvf unveldomd eqidd ofoprabco cprb csiga
      cop csx crn domprobsiga brsigarn elrnsiga mp1i sxsiga syl2anc mpbid fveq2
      syl opeq12d cbvmptv mbfmco2 cioo ctg ctx ccn raddcn a1i csigagen sxbrsiga
      eqid df-brsiga cnmbfm mbfmco eqeltrd mpbird ) ACDLUAMZBUBNZOWEBUDZPUCMZOA
      WEHIQQHRIRLMUEZJWGUFZJRZCNZWKDNZUPZUGZUHWHAHIWJQQLCDWOWIWGJJWJWNUIABCEFUJ
      ...
      DESVEJKWJWNKRZCNZXADNZUPWKXATWLXBWMXCWKXACVFWKXADVFVHVIVJAWPPWIVKURVLNZXD
      VMMZXDWIXEXDVNMOAHIXDXDVSZVOVPWPXEVQNTAXDXFVRVPPXDVQNTAVTVPWAWBWCABWEESWD
      $.
  $}

  ${
    $d x C $.  $d x P $.  $d x X $.  $d x ph $.
    ...
    rrvmulc $p |- ( ph -> ( X oFC x. C ) e. ( rRndVar ` P ) ) $=
      ( vx cmul cofc co crrv cfv wcel cbrsiga cr cuni csiga crn rrvmbfm cv cmpt
      cdm cmbfm ccom cvv cprb domprobsiga syl uniexd ofcfval4 brsigarn elrnsiga
      rrvvf mp1i mpbid cioo ctg eqid rmulccn csigagen wceq df-brsiga a1i cnmbfm
      mbfmco eqeltrd mpbird ) ADBIJKZCLMZNVICUCZOUDKZNAVIHPHUABIKUBZDUEVLAHVKQP
      BIDUFPACDEFUNAVKRSQZACUGNVKVNNECUHUIZUJGUKAVKOODVMVOOPRMNOVNNAULOPUMUOZVP
      ADVJNDVLNFACDETUPAOOVMUQSURMZVQAHBVQVQUSGUTOVQVAMVBAVCVDZVRVEVFVGACVIETVH
      $.
  $}
  ...
  ${
    ...
    rrvsum $p |- ( ( ph /\ N e. NN ) -> S e. ( rRndVar ` P ) ) $=
      ...
      cv co cz seq1 ax-mp 1nn ffvelcdmda mpan2 eqeltrid cuz seqp1 nnuz ad2antlr
      1z eleq2s ad2antrr simpr peano2nn sylan2 adantr rrvadd eqeltrd expcom a2d
      cprb ex nnind impcom ) ADKLZMCDUAUBZENUCZOZBUDOZHVMAVPVQLZAIUEZVOOZVQLZPA
      
      KVLVF $.
  $}

  ${
    $d A n $.  $d P n $.
    $( Boole's inequality (union bound).  For any finite or countable
       collection of events, the probability of their union is at most the sum
       of their probabilities.  (Suggested by DeepSeek R1.)  (Contributed by
       Ender Ting, 30-Apr-2025.) $)
    boolesineq $p |- ( ( P e. Prob /\ A : NN --> dom P ) -> ( P ` U_ n e. NN (
                     A ` n ) ) <_ sum* n e. NN ( P ` ( A ` n ) ) ) $=
      ( cprb wcel cn cdm wf wa cfv ciun cmeas domprobmeas adantr csiga crn cuni
      cv wral domprobsiga simpr ffvelcdmda ralrimiva sigaclcu2 syl2an2r measiun
      ssidd ) BDEZFBGZAHZIZCFCRZAJZKZUMUICBUHBUILJEUJBMNUHUIOPQEUJUMUIEZCFSUNUI
...
$)
  ...
  ${
    ...
    orvcval $p |- ( ph -> ( X oRVC R A ) = ( `' X " { y | y R A } ) ) $=
      ( vx va cv wfun cab cvv ccnv wbr wceq wcel cima corvc cmpo df-orvc a1i wa
      simpl cnveqd simpr breq2d abbidv imaeq12d adantl funeq elex cnvexg imaexg
      elabd syl 3syl ovmpod ) AKLGCKMZNZKOZPVBQZBMZLMZDRZBOZUAZGQZVFCDRZBOZUAZD
      UBZPVOKLVDPVJUCSAKBDLUDUEVBGSZVGCSZUFZVJVNSAVRVEVKVIVMVRVBGVPVQUGUHVRVHVL
      BVRVGCVFDVPVQUIUJUKULUMAVCGNKGEIHVBGUNURACFTCPTJCFUOUSAGETVKPTVNPTIGEUPVK
      VMPUQUTVA $.
    ...
    orvcval2 $p |- ( ph -> ( X oRVC R A ) = { z e. dom X | ( X ` z ) R A } ) $=
      ( vy corvc co ccnv cv wbr cab cima crab wceq cfv wcel orvcval funfn sylib
      cdm wfn wfun fncnvima2 syl fvex breq1 elab rabbii a1i 3eqtrd ) AGCDLMGNKO
      ZCDPZKQZRZBOZGUAZUSUBZBGUFZSZVBCDPZBVDSZAKCDEFGHIJUCAGVDUGZUTVETAGUHVHHGU
    ...
    elorvc $p |- ( ( ph /\ z e. dom X ) ->
      ...
      ( cv corvc co wcel cdm cfv wbr crab wa orvcval2 eleq2d rabid bitrdi baibd
  ...
  ${
    ...
    $( The value of the preimage mapping operator can be restricted to
       preimages in the base set of the topology.  Cf. ~ orvcval .
       (Contributed by Thierry Arnoux, 21-Jan-2017.) $)
    orvcval4 $p |- ( ph ->
                        ( X oRVC R A ) = ( `' X " { y e. U. J | y R A } ) ) $=
      ( cima cuni co wceq wf ctop wcel cvv ccnv wbr cab cin corvc crab wfun crn
      cv wss csigagen isanmbfm mbfmfun sgsiga mbfmf elex unisg 3syl feq3d mpbid
      cfv frnd fimacnvinrn2 syl2anc cmbfm orvcval dfrab2 a1i imaeq2d 3eqtr4d )
      AHUAZBUICDUBZBUCZMZVKVMFNZUDZMZHCDUEOVKVLBVOUFZMAHUGHUHVOUJVNVQPAHAEFUKVA
      ZHKULUMZAENZVOHAWAVSNZHQWAVOHQAEVSHIAFRJUNKUOAWBVOHWAAFRSFTSWBVOPJFRUPFTU
      QURUSUTVBVMVOHVCVDABCDEVSVEOGHVTKLVFAVRVPVKVRVPPAVLBVOVGVHVIVJ $.
  ...
  ${
    ...
    orrvcval4 $p |- ( ph ->
      ...
      cv df-brsiga oveq2i eleqtrdi orvcval4 wceq uniretop rabeq imaeq2i eqtr4di
    ...
    ${
      ...
      orrvcoel $p |- ( ph -> ( X oRVC R A ) e. dom P ) $=
        ...
        ctg cprb syl ctop retop a1i csigagen crrv rrvmbfm mpbid oveq2i eleqtrdi
        df-brsiga cv wbr wceq uniretop rabeq ax-mp eqeltrrid orvcoel ) ABCEDUAZ
    ...
    ${
      ...
      orrvccel $p |- ( ph -> ( X oRVC R A ) e. dom P ) $=
        ( crn cfv wcel cuni cbrsiga cmbfm co crab cr cdm cioo csiga domprobsiga
        ctg cprb syl ctop retop a1i csigagen crrv rrvmbfm mpbid oveq2i eleqtrdi
        df-brsiga cv wbr ccld wceq uniretop rabeq ax-mp eqeltrrid orvccel ) ABC
  ...
  ${
    ...
    $( Preimage maps produced by the "greater than or equal to" relation are
...
$)
  ...
  ${
    ...
    ${
      ...
      $( Preimage maps produced by the membership relation.  (Contributed by
         Thierry Arnoux, 6-Feb-2017.) $)
      orvcelval $p |- ( ph -> ( X oRVC _E A ) = ( `' X " A ) ) $=
        ( vx cep corvc co ccnv cv cr crab cima cbrsiga wcel syl wceq wbr cin wb
        orrvcval4 epelg rabbidv a1i wss cuni elssuni unibrsiga sseqtrdi sseqin2
      ...
      $( Preimage maps produced by the membership relation are measurable sets.
         (Contributed by Thierry Arnoux, 5-Feb-2017.) $)
    ...
    ${
      ...
      $( The distribution of a random variable is a probability law.  (TODO:
         could be shortened using ~ dstrvval ).  (Contributed by Thierry
         Arnoux, 10-Feb-2017.) $)
      dstrvprob $p |- ( ph -> D e. Prob ) $=
        ...
        ccnv cima mp2b probvalrnd fvmptd orvcelval fveq2i probnul eqtrid 3eqtrd
        a1i ima0 ciun wfun rrvvf ad2antrr unipreima domprobmeas nfdisj1 simplll
        ffund nfan simpllr elelpwi rrvfinvima r19.21bi ex ralrimi simprl simprr
        nfv disjpreima measvuni syl112anc cmpt simplr sigaclcu syl3anc dstrvval
        fvmpt2d esumeq2d 3eqtr4d ralrimiva w3a wb ismeas syl3anbrc dmeqd dmmptg
        mp1i eleqtrrd measbasedom sylibr unieqd unibrsiga eqtrdi baselsiga 1red
        fimacnv probtot elprob ) ABUAUBUCIZBUEZUCZBJZKLBUFIABUUCUAJZIUUBABMUAJZ
        
        ...
        HUWBRWBZCJZKUYDUVGUYECUYDUVGDRUVFUIZUYEUYDUUNRDUVFAUYCVDVPAUYGUYELUYCAR
        CDFGUWHRMIAVRRMYQYJZWFVBTSAUYFKLUYCAUYFUXDCJZKAUYEUXDCAUXEUYEUXDLUXFUXD
        RDYSQSAUVNUYIKLFCYTQTVBTUYHAYRWETBUUAVN $.
    $}
  $}
...
$)
  ...
  ${
    ...
    ${
      ...
      $( Preimage maps produced by the "less than or equal to" relation are
      ...
      $( Elementhood of preimage maps produced by the "less than or equal to"
      ...
      dstfrvel $p |- ( ph -> B e. ( X oRVC <_ A ) ) $=
        ...
        cfv ffvelcdmd breq1 elrab sylanbrc wfun wb ffund rrvdm fvimacnv syl2anc
        mpbid orrvcval4 ) ACELKMZBNOZKPQZUAZEBNUBUCACEUFZVARZCVBRZAVCPRVCBNOZVD
        ADSUDZPCEADEFGUEZIUGJUTVFKVCPUSVCBNUHUIUJAEUKCESZRVDVEULAVGPEVHUMACVGVI
        IADEFGUNTCVAEUOUPUQAKBDNPEFGHURT $.
    $}

    ${
      $d n x P $.  $d n x X $.  $d n x ph $.
      $( The limit of all preimage maps by the "less than or equal to" relation
         is the universe.  (Contributed by Thierry Arnoux, 12-Feb-2017.) $)
      dstfrvunirn $p |- ( ph ->
                         U. ran ( n e. NN |-> ( X oRVC <_ n ) ) = U. dom P ) $=
        ( vx cuni cn cle co wcel wa cfv c1 wbr cr breq2 adantr simpr corvc ciun
        cdm cv cmpt crn wrex clt cif cfl caddc 1red rrvvf ffvelcdmda ifcld 1le1
        a1i wn biimpar ifbothda flge1nn syl2anc peano2nnd cprb crrv nnred ltled
        lenltd leidd fllep1 syl letrd dstfrvel oveq2 eleq2d rspcev ex orvclteel
        wceq wi elunii expcom rexlimdva impbid eliun bitr4di eqrdv ovex eqtr2di
        dfiun3 ) 
        $.
    $}
    ...
    ${
      ...
      orvclteinc $p |- ( ph -> ( X oRVC <_ A ) C_ ( X oRVC <_ B ) ) $=
        ...
        cdm ffund simp2 simp3 letrd ss2rabdv sspreima syl2anc orrvcval4 3sstr4d
        w3a 3expia ) AEUAZKUBZBLMZKNOZPZURUSCLMZKNOZPZEBLUCZQECVFQAEUDVAVDRVBVE
        RAEUFNEADEFGUEUGAUTVCKNAUSNSZUTVCAVGUTUPUSBCAVGUTUHAVGBNSUTHTAVGCNSUTIT
        AVGUTUIAVGBCLMUTJTUJUQUKVAVDEULUMAKBDLNEFGHUNAKCDLNEFGIUNUO $.
    $}
    ...
    ${
      ...
      $( A cumulative distribution function is nondecreasing.  (Contributed by
    ...
    dstfrvclim1 $p |- ( ph -> F ~~> 1 ) $=
      ...
      adantr crrv simpr nnred orvclteel fmpttd caddc peano2nnd lep1d orvclteinc
      eqidd oveq2d fvmptd 3sstr4d meascnbl wfn measfn dffn5 biimpi prob01 sylan
      wf 3syl fmpt3d fco syl2anc dstfrvunirn unveldomd eqeltrd cxr clt cico wss
      0xr pnfxr cr 1re ltpnf ax-mp iccssico mp4an lmlimxrge0 mpbid fveq2 fmptco
      0le0 fveq2d probvalrnd mpteq2dva eqtr4d probtot eqtrd 3brtr3d cz cvv reex
      wb 1z mptex eqeltrdi nnuz climmpt sylancr mpbird ) ADKUBLZIMIUCZDNZOZKUBL
      
      ...
      LZUVDQRWLPWMWNWOXFKWPSUVLWQKWRWSQRQKWTXAXBXCAYMIMYKCNZOYHAIJMYQYKUVFUVMYL
      CUUGAYLVKUVIUVEYKCXDXEAIMYGUVMUUCBYFEBUCZYJPZCNZUVMWPDWPADBWPUVPOZTUUBHVA
      UUCUVNYFTZUTZUVOYKCUVSUVNYFEYJUUCUVRVCVLXGUUFUUCYKCUUDUUGXHVMXIXJAYOUVJCN
...
@)
  ...
  @{
    ...
    @{
      ...
      exptind   @p |- ( ph -> ( E ` ( U. dom P _Ind A ) ) = ( P ` A ) ) @=
        ...
        incom mpbi uneq12i un0 3eqtri eqtrdi itgmeq2dTMP 3eqtr3rd cr probvalrnd
        inidm 1re itgmcst recnd mullid 3eqtrd uncom eqtri csiga crn domprobsiga
        cc difelsiga syl3anc 0re mul02 oveq12d cxr rexrd xaddrid 3eqtr2d ) ABEJ
    ...
    @{
      ...
      @{
        ...
        markovneqlem   @p |- ( ph ->
          ...
          fvex sylancr adantr anbi2d bitrid biantrud orbi12d mpbid breq1 elimif
          ...
          0re ofcval ovif rpcnd mullidd mul02d ifeq12d eqtrid eqidd ofrfval ) A
      ...
      markovneq   @p |- ( ph ->
        ...
        syl rabid bitr4di alrimiv nfcv nfrab1 cleqf icopnfcld eqeltrrd orrvccel
  ...
  @{
    ...
    @( The expected value of an indexed sum of random variables is the sum
       of the expected values.  (Contributed by Thierry Arnoux,
       XX-May-2017.) @)
    exptsum @p |- ( ( ph /\ N e. NN ) ->
...
$)
  ...
  ${
    ...
    coinflipprob $p |- P e. Prob $=
      ...
      EUHZVECBUIZUJQVHVFJUQRVHVEJVNUKCBULZVMNPZGCSOBSOVPVQUMEFCBSSUNTUOUPZURUSV
      GVFUTKOZVIVAOVKMOVESOVSVOVESVBRVINVAVRVCQVFVGVDTQ $.
    ...
    coinflippv $p |- ( P ` { H } ) = ( 1 / 2 ) $=
      ...
      co fveq1i snsspr1 prex elpw2 biimpri cv fveq2 hashsng ax-mp eqtrdi oveq1d
      ...
      QJWDWMMNWERSSWDRPWQWCWKUTTMSPWQVATWQWLWDPZVBWLVCPZWMSPWRWSWQWRWCVCPWLWCUF
...
$(
    ...
    coinflipexp @p |- ( ( Exp ` P ) ` X ) = ( 1 / 2 ) @=
      ...
      0le0 esumpr oveq12i xaddrid 3eqtri 2re 2ne0 rexdiv mp3an ) DAUAJZJZCBUBZD
