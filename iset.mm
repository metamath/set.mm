...
$)
  ...
  ${
    ...
    $( Axiom of Extensionality.  It
       ...
       Axiom 1 of [Crosilla] (with unnnecessary quantifiers removed).
       ...
       axioms (except for axioms which involve wff
       metavariables).  In practice, though, the theorems and proofs are
  ...
  ${
    ...
    $( A bidirectional version of Extensionality.  Although this theorem
       ...
       comments for ~ ax-ext .  (Contributed by NM,
       14-Nov-2008.) $)
