...
$)
  ...
  $( Lemma for handling nested 'nand's.  (Contributed by NM, 19-Nov-2007.)
     (Revised by NM, 11-Dec-2008.) $)
  ...
  $( Show equivalence between implication and the Nicod version.  To derive
     ~ nic-dfim , apply ~ nic-justbi .  (Contributed by NM, 19-Nov-2007.)
     (Revised by NM, 17-Dec-2008.) $)
  ...
  $( Show equivalence between negation and the Nicod version.  To derive
     ~ nic-dfneg , apply ~ nic-justbi .  (Contributed by NM, 19-Nov-2007.)
     (Revised by NM, 16-Dec-2008.) $)
...
$)
  ...
  $( Nicod's axiom derived from the standard ones.  See _Intro. to Math.
     ...
     used in proofs, e.g. { ~ nic-ax , ~ nic-mp } is equivalent to { ~ luk-1 ,
     ~ luk-2 , ~ luk-3 , ~ ax-mp }.  In a pure (standalone) treatment of
     Nicod's axiom, this theorem would be changed to an axiom ($a statement).
     (Contributed by Jeff Hoffman, 19-Nov-2007.) $)
  nic-ax $p |- ( ( ph -/\ ( ch -/\ ps ) ) -/\
                   ( ( ta -/\ ( ta -/\ ta ) ) -/\
                     ( ( th -/\ ch ) -/\
...
$)
  ...
  $( Lemma for ~ nic-id .  (Contributed by NM, 17-Nov-2007.)  (Revised by NM,
     11-Dec-2008.) $)
  ...
  ${
    ...
    $( Lemma for ~ nic-id .  Inference used by ~ nic-id .  (Contributed by NM,
       17-Nov-2007.)  (Revised by NM, 11-Dec-2008.) $)
...
$)
  ...
  ${
    ...
    $( Inference to extract one side of an implication from a definition.
       (Contributed by NM, 18-Nov-2007.)  (Revised by NM, 11-Dec-2008.) $)
    nic-bi1 $p |- ( ph -/\ ( ps -/\ ps ) ) $=
  ...
  ${
    ...
    $( Inference to extract the other side of an implication from a
       'biconditional' definition.  (Contributed by NM, 18-Nov-2007.)  (Revised
       by NM, 11-Dec-2008.) $)
    nic-bi2 $p |- ( ps -/\ ( ph -/\ ph ) ) $=
