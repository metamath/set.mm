...
ax-6 $p |- ( -. A. x -. A. x ph -> ph ) $=
  ( wal wn wi ax-4 id ax-gen ax-5 ax-mp nsyl syl con3i pm2.21 ax-467 3syl ) ABC
  ZDZBCZDQBCZDZBCZBCZDUCQEAUCSUCREZBCUCSEUDBUCUBRUBBFUBTQUABFQQEZBCQTEUEBQGHAQB
  IJKLHUBRBIJMUCQNABBOP $.
  $( [?] $) $( [27-Oct-2010] $)

ax-7 $p |- ( A. x A. y ph -> A. y A. x ph ) $=
  ( wal wn ax-6 con4i wi ax-4 pm2.21 ax-467 3syl ax-gen ax-5 ax-mp nsyl4 syl ) 
  ACDBDZREZCDZEZCDZABDZCDZUBRSCFGUBUCHZCDUBUDHUECUBUAUCUACITBDZEZBDZUCTUHAHZBDU
  HUCHUIBUHUGUFUCHAUGBIUFUCJABCKLMUGABNOTBFPQMUAUCCNOQ $.
  $( [?] $) $( [27-Oct-2010] $)
