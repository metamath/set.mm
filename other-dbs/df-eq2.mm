...
$( We will use the following descriptive terms very loosely:  A "theorem"
  ...
  ${
    ...
    imim12i $p |- ( ( ps -> ch ) -> ( ph -> th ) ) $=
      ...
      $( [3-Nov-2011] $) $( [5-Aug-1993] $)

    $( Inference joining two implications. $)
    imim12iOLD $p |- ( ( ps -> ch ) -> ( ph -> th ) ) $=
...
$)
  ...
  bi1 $p |- ( ( ph <-> ps ) -> ( ph -> ps ) ) $=
    ( wb wi wn df-bi simplim ax-mp syl ) ABCZABDZBADZEDEZKJMDZMJDZEDENABFNOGHKL
    GI $.
    $( [11-May-1999] $)

  $( Property of the biconditional connective. $)
  bi2 $p |- ( ( ph <-> ps ) -> ( ps -> ph ) ) $=
    ( wb wi wn df-bi simplim ax-mp simprim syl ) ABCZABDZBADZEDEZMKNDZNKDZEDEOA
    BFOPGHLMIJ $.
    $( [11-May-1999] $)
...
$)
  ...
  $( Elimination of a conjunct.  Theorem *3.26 (Simp) of [WhiteheadRussell]
     p. 112. $)
  simpl $p |- ( ( ph /\ ps ) -> ph ) $=
    ( wa wn wi df-an simplim sylbi ) ABCABDEDAABFABGH $.
    $( [5-Aug-1993] $)
  ...
  ${
    ...
    $( Deduction eliminating a conjunct. $)
    simprbda $p |- ( ( ph /\ ps ) -> ch ) $=
      ( wa biimpa simplld ) ABFCDABCDFEGH $.
      $( [22-Oct-2007] $)
  ...
  pm5.3OLD $p |- ( ( ( ph /\ ps ) -> ch ) <->
               ( ( ph /\ ps ) -> ( ph /\ ch ) ) ) $=
    ( wa wi pm3.3 imdistand simpr imim2i impbii ) ABDZCEZKACDZELABCABCFGMCKACHI
    J $.
    $( [3-Jan-2005] $)
  ...
  ordi $p |- ( ( ph \/ ( ps /\ ch ) ) <-> ( ( ph \/ ps ) /\ ( ph \/ ch ) ) ) $=
    ( wa wo simpl orim2i simpr jca wn orel1 anim12d com12 orrd impbii ) ABCDZEZ
    ABEZACEZDZQRSPBABCFGPCABCHGITAPAJZTPUARBSCABKACKLMNO $.
    $( [12-May-2011] $) $( [5-Aug-1993] $)
  ...
  ordiOLD $p |- ( ( ph \/ ( ps /\ ch ) ) <-> ( ( ph \/ ps ) /\ ( ph \/ ch ) )
    ...
    ( wa wo simpl orim2i simpr jca wn wi df-or pm3.43i 3imtr4g sylbi imp
...
$)
  ...
  elimant $p |- ( ( ( ph -> ps ) /\ ( ( ps -> ch ) -> ( ph -> th ) ) ) ->
                ( ph -> ( ch -> th ) ) ) $=
    ( wi wa simpr ax-1 syl5 com23 ) ABEZBCEZADEZEZFZCADOLMCKNGCBHIJ $.
  ...
  ${
    ...
    $( An inference based on modus ponens.  (The proof was shortened by Andrew
       Salmon, 7-May-2011.) $)
    mpanl2 $p |- ( ( ph /\ ch ) -> th ) $=
      ( wa an1rs mpan2 ) ACGBDEABCDFHI $.
      $( [12-May-2011] $) $( [16-Aug-1994] $)
  ...
  ${
    ...
    $( An inference based on modus ponens.  (The proof was shortened by Andrew
       Salmon, 7-May-2011.) $)
    mpanr2 $p |- ( ( ph /\ ps ) -> th ) $=
      ( wa anassrs mpan2 ) ABGCDEABCDFHI $.
      $( [12-May-2011] $) $( [3-May-1994] $)
  ...
  ${
    ...
    biantrud $p |- ( ph -> ( ch <-> ( ch /\ ps ) ) ) $=
      ( wa anim2i expcom simpl impbid1 ) ACCBEZCAJABCDFGCBHI $.
      $( [2-Aug-1994] $)
  ...
  pm5.75OLD $p |- ( ( ( ch -> -. ps ) /\ ( ph <-> ( ps \/ ch ) ) ) ->
    ...
    impcom simpl jcad impbid ) CBDZEZABCFZGZHZAUCHZCUFUHCEZUDUFAUEEUIAUEIABCJKL
    UGCAUCUFUDCAEUFCUCAUFCUCAUFCBAFZEZCUCHAEUFUEAEUKAUEMCUEAUJCBNABNOPCBAJKQRSU
    DUFTUAUB $.
    $( [3-Jan-2005] $)
  ...
  ${
    ...
    ecase2d $p |- ( ph -> ta ) $=
      ( wo wn ioran wa wi imnan sylibr mpd sylanbrc orcom sylib ord ) ACDJZKZEU
      CCKZDKZACDLABUDFABCMKBUDNGBCOPQABUEFABDMKBUENHBDOPQRAUBEAEUBJUBEJIEUBSTUA
      Q $.
      $( [21-Apr-1994] $)
  $}
  ...
  dedlemaOLD $p |- ( ph -> ( ps <-> ( ( ps /\ ph ) \/ ( ch /\ -. ph ) ) ) ) $=
  ...
  $( Lemma for weak deduction theorem. $)
  dedlembOLD $p |- ( -. ph -> ( ch <-> ( ( ps /\ ph ) \/ ( ch /\ -. ph ) ) )
        ) $=
    ( wn wa wo olc expcom wi pm2.21 com23 imp3a simpl a1i jaod impbid ) ADZCBAE
    ZCQEZFZCQTSRGHQRCSQBACQABCABCIJKLSCIQCQMNOP $.
    $( [15-May-1999] $)
  ...
  consensusOLD $p |- ( ( ( ( ph /\ ps ) \/ ( -. ph /\ ch ) ) \/ ( ps /\ ch ) )
               <-> ( ( ph /\ ps ) \/ ( -. ph /\ ch ) ) ) $=
...
$)
  ...
  $( Negated triple conjunction expressed in terms of triple disjunction.
     (Contributed by Jeff Hankins, 15-Aug-2009.) $)
  3ianorOLD $p |- ( -. ( ph /\ ps /\ ch ) <-> ( -. ph \/ -. ps \/ -. ch ) ) $=
    ( w3a wn w3o 3anor notbii notnot bitr4i ) ABCDZEAEBECEFZEZELKMABCGHLIJ $.
    $( [2-Mar-2011] $) $( [28-Jul-2009] $)
  ...
  $( Simplification of triple conjunction. $)
  simp1 $p |- ( ( ph /\ ps /\ ch ) -> ph ) $=
    ( w3a 3simpa simplld ) ABCDABABCEF $.
    $( [21-Apr-1994] $)
  ...
  ${
    ...
    3anibar $p |- ( ( ph /\ ps /\ ch ) -> ( th <-> ta ) ) $=
      ( w3a wa wb ibar 3ad2ant3 bitr4d ) ABCGDCEHZEFCAEMIBCEJKL $.
  ...
  ${
    ...
    exp516 $p |- ( ph -> ( ps -> ( ch -> ( th -> ( ta -> et ) ) ) ) ) $=
      ( wi w3a wa ex 3exp2 ) ABCDEFHABCDIJEFGKL $.
      $( [21-Feb-2011] $) $( [8-Jul-2009] $)
  $}
  ...
  ${
    ...
    ${
      ...
      $( Syllogism combined with contraction. $)
      syl32anc $p |- ( ph -> ze ) $=
        ( w3a 3jca syl12anc ) ABCDNEFGABCDHIJOKLMP $.
        $( [11-Mar-2012] $)
    $}
  ...
  ${
    ...
    $( Inference conjoining and disjoining the antecedents of three
       implications.  (Contributed by Jeff Hankins, 15-Aug-2009.) $)
    3jaaoOLD $p |- ( ( ph /\ th /\ et ) -> ( ( ps \/ ta \/ ze ) -> ch ) ) $=
      ( w3o wi wa wo jaao df-3or syl5ib 3impa ) ADFBEGKZCLADMZFMBENZGNCSTUACFGA
      BCDEHIOJOBEGPQR $.
      $( [2-Mar-2011] $) $( [3-Aug-2009] $)
  $}
  ...
  ${
    ...
    3anandis $p |- ( ( ph /\ ( ps /\ ch /\ th ) ) -> ta ) $=
      ( w3a wa simp1 anim2i simp2 simp3 syl111anc ) ABCDGZHABHACHADHENBABCDIJNC
      ABCDKJNDABCDLJFM $.
      $( [18-Apr-2007] $)
  $}
  ...
  ${
    ...
    3anandirs $p |- ( ( ( ph /\ ps /\ ch ) /\ th ) -> ta ) $=
      ( w3a wa simp1 anim1i simp2 simp3 syl111anc ) ABCGZDHADHBDHCDHENADABCIJNB
      DABCKJNCDABCLJFM $.
...
$)
  ...
  $( ` F. ` is not provable.  (Contributed by Anthony Hart, 22-Oct-2010.)  (The
     proof was shortened by Mel L. O'Cat, 10-Mar-2012.) $)
  notfalOLD $p |- -. F. $=
    ( wfal wtru tru wn df-fal biimpi mt2 ) ABCABDEFG $.
    $( [11-Mar-2012] $) $( [22-Oct-2010] $)

  $( ` F. ` is not provable.  (Contributed by Anthony Hart, 22-Oct-2010.) $)
  notfalOLDOLD $p |- -. F. $=
    ( wtru wfal wn tru df-fal con2bii mpbi ) ABCDBAEFG $.
    $( [6-Sep-2010] $) $( [22-Oct-2010] $)
...
$)
  ...
  ${
    ...
    ee11.2 $e |- ( ph -> ch ) $.
    ee11.3 $e |- ( ps -> ( ch -> th ) ) $.
    $( ~ e11 without virtual deductions. ~ sylc is also ~ e11 without virtual
       deductions, except with a different order of hypotheses.  (Contributed
       by Alan Sare, 8-Jul-2011.) $)
    ee11 $p |- ( ph -> th ) $=
      ( sylc ) ABCDEFGH $.
      $( [8-Jul-2011] $)
  $}
  ...
  ${
    ...
    ee222 $p |- ( ph -> ( ps -> et ) ) $=
      ( wa imp wi sylc mpd ex ) ABFABKZEFABEILQCDEFMABCGLABDHLJNOP $.
  ...
  ${
    ...
    $( ~ e13 without virtual deduction connectives.  Special theorem needed for
       ...
       Sare, 28-Oct-2011.) $)
    ee13 $p |- ( ph -> ( ch -> ( th -> et ) ) ) $=
      ( wi com12 syl8 com34 syl7 pm2.43a ) CADFJZACBPAACDBFACDEBFJHBEFIKLMGNO
      $.
      $( [28-Oct-2011] $)
  $}
  ...
  ${
    ...
    $( ~ e23 without virtual deductions.  (Contributed by Alan Sare,
       17-Jul-2011.) $)
    ee23 $p |- ( ph -> ( ps -> ( th -> et ) ) ) $=
      ( wi syl6 com3r syl8 com24 pm2.43i pm2.43d ) ABDFJADBBFADBBFJZJJABDAQABDE
      AQJHABEFABCEFJGIKLMNONP $.
      $( [17-Jul-2011] $)
  $}
  ...
  ${
    ...
    ee333 $p |- ( ph -> ( ps -> ( ch -> ze ) ) ) $=
      ( w3a 3imp wi sylc mpd 3exp ) ABCGABCLZFGABCFJMRDEFGNABCDHMABCEIMKOPQ $.
      $( [17-Jul-2011] $)
  $}
  ...
  3ornot23 $p |- ( ( -. ph /\ -. ps ) -> ( ( ch \/ ph \/ ps ) -> ch ) ) $=
    ( wn wa wo w3o ioran biimpri wi 3orass biimpi a1i orel2 sylsyld ) ADBDEZABF
    ZDZCABGZCQFZCRPABHISTJPSTCABKLMQCNO $.
    $( [31-Dec-2011] $)

  $( ~ orbi1 with order of disjuncts reversed.  Derived from ~ orbi1rVD .
     (Contributed by Alan Sare, 31-Dec-2011.) $)
  orbi1r $p |- ( ( ph <-> ps ) -> ( ( ch \/ ph ) <-> ( ch \/ ps ) ) ) $=
    ( wb wo orbi1 pm1.4 syl5bi syl6 syl5bir impbid ) ABDZCAEZCBEZLMBCEZNLACEZOM
    ABCFZCAGHBCGILNPMLPONQCBGJACGIK $.
    $( [31-Dec-2011] $)
  ...
  bitr3 $p |- ( ( ph <-> ps ) -> ( ( ph <-> ch ) -> ( ps <-> ch ) ) ) $=
    ( wb id bicomd wi a1i biantr ee12an ) ABDZBADACDZCADZBCDKABKEFLMGKLACLEFHBA
    CIJ $.
    $( [31-Dec-2011] $)
  ...
  3impexp $p |- ( ( ( ph /\ ps /\ ch ) -> th ) <->
                ( ph -> ( ps -> ( ch -> th ) ) ) ) $=
    ( w3a wi wa wb df-3an imbi1 biimpcd mpi exp4c pm3.31 imp3a syl5ib impbii )
    ABCEZDFZABCDFZFFZSABCDSRABGZCGZHZUCDFZABCIZUDSUERUCDJKLMUAUCDRUAUBCDABTNOUF
    PQ $.
    $( [31-Dec-2011] $)
  ...
  ${
    ...
    3impexpbicomi $p |- ( ph -> ( ps -> ( ch -> ( ta <-> th ) ) ) ) $=
      ( w3a wb wi 3impexpbicom mpbi ) ABCGDEHIABCEDHIIIFABCDEJK $.
      $( [31-Dec-2011] $)
  $}
  ...
  com3rgbi $p |- ( ( ph -> ( ps -> ( ch -> th ) ) ) <->
                 ( ch -> ( ph -> ( ps -> th ) ) ) ) $=
    ( wi pm2.04 imim2i syl impbii ) ABCDEEZEZCABDEZEEZKACLEZEZMJNABCDFGACLFHMOK
    CALFNJACBDFGHI $.
    $( [18-Mar-2012] $)
  ...
  ${
    ...
    exp3acom3r $p |- ( ps -> ( ch -> ( ph -> th ) ) ) $=
      ( wa wi impexp3acom3r biimpi ax-mp ) ABCFDGGZBCADGGGZEKLABCDHIJ $.
      $( [18-Mar-2012] $)
  $}
...
$)
  ...
  ax-alim $a |- ( A. x ( ph -> ps ) -> ( A. x ph -> A. x ps ) ) $.

  ax-alne $a |- ( -. A. x ph -> A. x -. A. x ph ) $.

  ax-alcom $a |- ( A. x A. y ph -> A. y A. x ph ) $.
...
$(
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
        Initial predicate calculus theorems
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$)
  ...
  ${
    ...
    alimi $p |- ( A. x ph -> A. x ps ) $=
      ( wi wal ax-alim mpg ) ABEACFBCFECABCGDH $.
      $( [?] $) $( [15-May-2012] $)
  $}
  ...
  ${
    ...
    al2imi $p |- ( A. x ph -> ( A. x ps -> A. x ch ) ) $=
      ( wal wi alimi ax-alim syl ) ADFBCGZDFBDFCDFGAKDEHBCDIJ $.
      $( [?] $) $( [15-May-2012] $)
  $}
...
$)
  ...
  ${ $d x z $. $d y z $.
     eqid $p |- x = x $=
       ( vz weq wel wb df-eq biid mpgbir ) AACBADZIEBAABFIGH $.
       $( [?] $) $( [15-May-2012] $)

     eqcom $p |- ( x = y <-> y = x ) $=
       ( vz wel wb wal weq bicom albii df-eq 3bitr4i ) CADZCBDZEZCFMLEZCFABGBAG
       NOCLMHIABCJBACJK $.
       $( [?] $) $( [15-May-2012] $)
  $}
  ...
  ${ $d x w $. $d y w $. $d z w $.
     eqtr $p |- ( ( x = y /\ y = z ) -> x = z ) $=
       ( vw wel wb wa wal weq bitr alimi df-eq anbi12i alan bitr4i 3imtr4i ) DA
       EZDBEZFZRDCEZFZGZDHZQTFZDHABIZBCIZGZACIUBUDDQRTJKUGSDHZUADHZGUCUEUHUFUIA
       BDLBCDLMSUADNOACDLP $.
       $( [?] $) $( [15-May-2012] $)
  $}
  ...
  eqeq1 $p |- ( x = y -> ( x = z <-> y = z ) ) $=
    ( weq wi eqtr ex eqcoms impbid ) ABDZACDZBCDZKLEBABADKLBACFGHJLKABCFGI $.
    $( [?] $) $( [15-May-2012] $)
...
$)
  ...
  ax-elsb $a |- -. A. z -. ( ( z e. x -> z e. y ) -> ( w e. x -> w e. y ) ) $.

  ax-ext $a |- -. A. z -. ( ( z e. x -> z e. y ) -> 
